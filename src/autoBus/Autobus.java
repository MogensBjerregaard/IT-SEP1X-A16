...
public class Autobus extends JFrame {
	...
	private void loadArchives() throws Exception {
		...
		if (toursArchive.isFileFound()) {
			toursArchive.load();
			/* TESTING FEATURE */ toursArchive.add(new Tour("Chisinau", new ArrayList<String>(), 0, new Services(),
					new Chauffeur(), new Bus(), new DateInterval()));
			toursArchive.add(new Tour("Chisinau", new ArrayList<String>(), 0, new Services(), new Chauffeur(),
					new Bus(), new DateInterval()));
			toursArchive.add(new Tour("Tokio", new ArrayList<String>(), 0, new Services(), new Chauffeur(), new Bus(),
					new DateInterval()));
			toursArchive.add(new Tour("Benderi", new ArrayList<String>(), 0, new Services(), new Chauffeur(), new Bus(),
					new DateInterval()));
			listTours();
		} else {
	...
	private void createEvents() {
		...
		lblSelectTourButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent arg0) {
				...
				if (index != -1) {
					...
					/*
					 * + " " +
					 * toursArchive.getListOfTours().get(index).getDateInterval(
					 * ).getStartDate()
					 */);
				} else {
		...
		lblSelectCustomerButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent arg0) {
				...
				if (index != -1) {
					lblSelectedCustomer
							.setText("Customer: " + customersArchive.getListOfCustomers().get(index).getName());
				} else {
				...
				if (indexes != null) {
					if (indexes.length == 1) {
						lblSelectedPassengers.setText(
								"Passenger: " + passengersArchive.getListOfPassengers().get(indexes[0]).getName());
					} else {
		...
		searchTourTextField.getDocument().addDocumentListener(new DocumentListener() {
			...
			public void changedUpdate(DocumentEvent e) {
				...
				if (!(searchText = searchTourTextField.getText()).equals("")) {
					...
					deleteAllRows(toursTableModelForNewReservation = (DefaultTableModel) tableToursForNewReservation
							.getModel());
					toursTableModelForNewReservation = (DefaultTableModel) tableToursForNewReservation.getModel();
					Object[] rowData = new Object[5];
					for (int i = 0; i < toursArchive.getListOfTours().size(); i++) {
		...
		mntmAboutAutobus.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				JOptionPane.showMessageDialog(null,
						...
						"About autobut\u00AE", JOptionPane.INFORMATION_MESSAGE, icon);
			}
		});
		...
		lblAddChauffeurButton.addMouseListener(new MouseAdapter() {
			...
			public void mouseReleased(MouseEvent arg0) {
				...
				if (str.equals("")) {
					...
					updateListChauffeurs(textFieldEmployeeNo.getText(), chckbxExternalEmployee.isSelected(),
							textFieldChauffeurName.getText(), textFieldChauffeurAddress.getText(),
							textFieldChauffeurEmail.getText(), textFieldChauffeurPhone.getText(),
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////
	// This method contains all code for prompting the user for a ok / cancel
	//////////////////////////////////////////////////////////////////////////////////////////////////////// message
	///////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////
	// This method contains all code for adding all chauffeurs from file archive
	//////////////////////////////////////////////////////////////////////////////////////////////////////// to
	//////////////////////////////////////////////////////////////////////////////////////////////////////// table
	//////////////////////////////////////////////////////////////////////////////////////////////////////// of
	//////////////////////////////////////////////////////////////////////////////////////////////////////// chauffeurs
	...
	///////////////////////////////////////////////////////////////////////////////////////////////////////
	public void updateListChauffeurs(String employeeNumber, boolean externalEmployee, String name, String address,
	...
	////////////////////////////////////////////////////////////////////////////////////////////////////////
	// This method contains all code for adding all buses from file archive to
	//////////////////////////////////////////////////////////////////////////////////////////////////////// table
	//////////////////////////////////////////////////////////////////////////////////////////////////////// of
	//////////////////////////////////////////////////////////////////////////////////////////////////////// buses
	///////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	private void initComponents() {
		...
		tourReservationScrollPane.setBorder(new CompoundBorder(
				new TitledBorder(new LineBorder(new Color(255, 255, 255), 1, true), "Tour Reservation Archive",
		...
		gl_busReservationTitlePanel.setHorizontalGroup(gl_busReservationTitlePanel
				.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_busReservationTitlePanel.createSequentialGroup().addContainerGap()
						.addComponent(labelBusReservations, GroupLayout.PREFERRED_SIZE, 378, GroupLayout.PREFERRED_SIZE)
						.addContainerGap(610, Short.MAX_VALUE)));
		gl_busReservationTitlePanel.setVerticalGroup(gl_busReservationTitlePanel.createParallelGroup(Alignment.LEADING)
		...
		busReservationScrollPane
				.setBorder(new CompoundBorder(new TitledBorder(new LineBorder(new Color(255, 255, 255), 1, true),
						"Bus & Chauffeur Reservation Archive", TitledBorder.CENTER, TitledBorder.TOP, null,
						new Color(255, 255, 255)), new EmptyBorder(5, 5, 5, 5)));
		...
		busReservationUpdatePanel.setBorder(new TitledBorder(new LineBorder(new Color(255, 255, 255), 1, true),
				"Update Bus & Chauffeur Reservation", TitledBorder.CENTER, TitledBorder.TOP, null,
		...
		gl_busReservationUpdatePanel.setHorizontalGroup(gl_busReservationUpdatePanel
				.createParallelGroup(Alignment.TRAILING)
				.addGroup(Alignment.LEADING, gl_busReservationUpdatePanel.createSequentialGroup().addContainerGap()
						.addGroup(gl_busReservationUpdatePanel.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_busReservationUpdatePanel.createSequentialGroup().addGap(21)
										.addComponent(lblUpdateBus).addContainerGap())
								.addGroup(gl_busReservationUpdatePanel.createParallelGroup(Alignment.LEADING)
										...
										.addGroup(gl_busReservationUpdatePanel.createParallelGroup(Alignment.LEADING)
												.addGroup(gl_busReservationUpdatePanel.createSequentialGroup()
														.addGroup(gl_busReservationUpdatePanel
																.createParallelGroup(Alignment.LEADING)
																.addComponent(lblCustomer).addComponent(lblDuration)
																.addComponent(lblDistance).addComponent(lblDropoffStops)
																.addComponent(lblDepartureTime)
																.addComponent(lblArrivalTimeTo,
																		GroupLayout.PREFERRED_SIZE, 94,
																		GroupLayout.PREFERRED_SIZE)
																.addComponent(lblArrivalBack,
																		GroupLayout.PREFERRED_SIZE, 94,
																		GroupLayout.PREFERRED_SIZE)
														...
														.addGroup(gl_busReservationUpdatePanel
																...
																.addGroup(gl_busReservationUpdatePanel
																		...
																		.addComponent(
																				busReservationDropOffStopsTextField)
																		.addComponent(busReservationDurationTextField)
																		.addComponent(
																				busReservationCustomerNameTextField,
																				GroupLayout.DEFAULT_SIZE, 177,
																				Short.MAX_VALUE)
																		.addComponent(busReservationDistanceTextField)
																		.addComponent(
																				busReservationPickUpStopsTextField))
																.addComponent(busReservationDepartureTimeTextField,
																...
																.addGroup(gl_busReservationUpdatePanel
																		...
																		.addGroup(gl_busReservationUpdatePanel
																				.createParallelGroup(Alignment.TRAILING,
																						false)
																				.addComponent(
																						busReservationArrivalBackTextField,
																						Alignment.LEADING)
																				.addComponent(
																						busReservationArrivalTimeTextField,
																						Alignment.LEADING,
																						GroupLayout.DEFAULT_SIZE, 179,
																						Short.MAX_VALUE)
																				.addComponent(
																						busReservationNumberOfPassengersTextField,
																						GroupLayout.PREFERRED_SIZE, 179,
																						GroupLayout.PREFERRED_SIZE))
																		.addContainerGap())))
												.addGroup(gl_busReservationUpdatePanel.createSequentialGroup()
														.addComponent(lblNumberOfPassengers, GroupLayout.PREFERRED_SIZE,
																116, GroupLayout.PREFERRED_SIZE)
														.addContainerGap(188, Short.MAX_VALUE))
												.addGroup(gl_busReservationUpdatePanel.createSequentialGroup()
														.addComponent(lblDateOfCreation, GroupLayout.DEFAULT_SIZE, 111,
																Short.MAX_VALUE)
														.addPreferredGap(ComponentPlacement.RELATED)
														.addComponent(busReservationDateOfCreationTextField,
																GroupLayout.PREFERRED_SIZE, 179,
																GroupLayout.PREFERRED_SIZE)
														.addContainerGap()))))));
		gl_busReservationUpdatePanel
				.setVerticalGroup(gl_busReservationUpdatePanel.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_busReservationUpdatePanel.createSequentialGroup().addContainerGap()
								.addGroup(gl_busReservationUpdatePanel.createParallelGroup(Alignment.BASELINE)
										.addComponent(lblCustomer).addComponent(busReservationCustomerNameTextField,
												GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
												GroupLayout.PREFERRED_SIZE))
								.addPreferredGap(ComponentPlacement.RELATED)
								.addGroup(gl_busReservationUpdatePanel.createParallelGroup(Alignment.BASELINE)
										.addComponent(lblDuration).addComponent(busReservationDurationTextField,
												GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
												GroupLayout.PREFERRED_SIZE))
								.addPreferredGap(ComponentPlacement.RELATED)
								.addGroup(gl_busReservationUpdatePanel.createParallelGroup(Alignment.BASELINE)
										.addComponent(lblDistance).addComponent(busReservationDistanceTextField,
												GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
												GroupLayout.PREFERRED_SIZE))
								.addPreferredGap(ComponentPlacement.RELATED)
								.addGroup(gl_busReservationUpdatePanel.createParallelGroup(Alignment.BASELINE)
										.addComponent(lblPickupStops).addComponent(busReservationPickUpStopsTextField,
												GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
												GroupLayout.PREFERRED_SIZE))
								.addPreferredGap(ComponentPlacement.RELATED)
								.addGroup(gl_busReservationUpdatePanel.createParallelGroup(Alignment.BASELINE)
										.addComponent(lblDropoffStops).addComponent(busReservationDropOffStopsTextField,
												GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
												GroupLayout.PREFERRED_SIZE))
								.addPreferredGap(ComponentPlacement.RELATED)
								.addGroup(gl_busReservationUpdatePanel.createParallelGroup(Alignment.BASELINE)
										.addComponent(lblDepartureTime)
										.addComponent(busReservationDepartureTimeTextField, GroupLayout.PREFERRED_SIZE,
												16, GroupLayout.PREFERRED_SIZE))
								.addPreferredGap(ComponentPlacement.RELATED)
								.addGroup(gl_busReservationUpdatePanel.createParallelGroup(Alignment.BASELINE)
										.addComponent(lblArrivalTimeTo, GroupLayout.PREFERRED_SIZE, 16,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(busReservationArrivalTimeTextField, GroupLayout.PREFERRED_SIZE,
												16, GroupLayout.PREFERRED_SIZE))
								.addPreferredGap(ComponentPlacement.RELATED)
								.addGroup(gl_busReservationUpdatePanel.createParallelGroup(Alignment.BASELINE)
										.addComponent(lblArrivalBack, GroupLayout.PREFERRED_SIZE, 16,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(busReservationArrivalBackTextField, GroupLayout.PREFERRED_SIZE,
												16, GroupLayout.PREFERRED_SIZE))
								.addPreferredGap(ComponentPlacement.RELATED)
								.addGroup(gl_busReservationUpdatePanel.createParallelGroup(Alignment.BASELINE)
										.addComponent(lblNumberOfPassengers, GroupLayout.PREFERRED_SIZE, 16,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(busReservationNumberOfPassengersTextField,
												GroupLayout.PREFERRED_SIZE, 16, GroupLayout.PREFERRED_SIZE))
								.addPreferredGap(ComponentPlacement.RELATED)
								.addGroup(gl_busReservationUpdatePanel.createParallelGroup(Alignment.BASELINE)
										.addComponent(lblDateOfCreation, GroupLayout.PREFERRED_SIZE, 16,
												GroupLayout.PREFERRED_SIZE)
										.addComponent(busReservationDateOfCreationTextField, GroupLayout.PREFERRED_SIZE,
												16, GroupLayout.PREFERRED_SIZE))
		...
		gl_panelChauffeurs.setHorizontalGroup(gl_panelChauffeurs.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelChauffeurs.createSequentialGroup()
						.addComponent(panelTopChauffeurs, GroupLayout.DEFAULT_SIZE, 1000, Short.MAX_VALUE).addGap(0))
				.addGroup(gl_panelChauffeurs.createSequentialGroup().addGap(12)
						...
						.addGroup(gl_panelChauffeurs.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panelChauffeurs.createSequentialGroup().addComponent(lblDeleteChauffeurBtn)
										.addContainerGap())
								.addGroup(gl_panelChauffeurs.createSequentialGroup()
										.addComponent(scrollPaneChauffeursArchive, GroupLayout.DEFAULT_SIZE, 612,
												Short.MAX_VALUE)
										.addGap(40)))));
		gl_panelChauffeurs.setVerticalGroup(gl_panelChauffeurs.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelChauffeurs.createSequentialGroup()
						...
						.addGroup(gl_panelChauffeurs.createParallelGroup(Alignment.TRAILING, false)
								.addComponent(scrollPaneChauffeursArchive, 0, 0, Short.MAX_VALUE).addComponent(
										panelAddChauffeur, GroupLayout.DEFAULT_SIZE, 368, Short.MAX_VALUE))
						.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(lblDeleteChauffeurBtn)
		...
		tableChauffeurs.setModel(new DefaultTableModel(new Object[][] {},
				new String[] { "#", "External", "Name", "Address", "Email", "Phone", "Birthday", "1 d only" }));
		...
		gl_panelBuses.setHorizontalGroup(
				gl_panelBuses.createParallelGroup(Alignment.LEADING).addGap(0, 1000, Short.MAX_VALUE)
						.addGroup(gl_panelBuses.createSequentialGroup()
								.addComponent(panelTopBuses, GroupLayout.DEFAULT_SIZE, 1000, Short.MAX_VALUE).addGap(0))
						.addGroup(gl_panelBuses.createSequentialGroup().addGap(12)
								.addComponent(panelAddBus, GroupLayout.PREFERRED_SIZE, 318,
										GroupLayout.PREFERRED_SIZE)
								.addGap(18)
								.addGroup(gl_panelBuses.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_panelBuses.createSequentialGroup().addComponent(labelDeleteBusBtn)
												.addContainerGap())
										.addGroup(
												gl_panelBuses
														.createSequentialGroup().addComponent(scrollPaneBusesArchive,
																GroupLayout.DEFAULT_SIZE, 612, Short.MAX_VALUE)
														.addGap(40)))));
		gl_panelBuses
				.setVerticalGroup(gl_panelBuses.createParallelGroup(Alignment.LEADING).addGap(0, 494, Short.MAX_VALUE)
						.addGroup(gl_panelBuses.createSequentialGroup()
								...
								.addGroup(gl_panelBuses.createParallelGroup(Alignment.TRAILING, false)
										.addComponent(scrollPaneBusesArchive, 0, 0, Short.MAX_VALUE).addComponent(
												panelAddBus, GroupLayout.DEFAULT_SIZE, 368, Short.MAX_VALUE))
								.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(labelDeleteBusBtn)
								.addContainerGap(13, Short.MAX_VALUE)));
		...
		tableBuses.setModel(new DefaultTableModel(new Object[][] {}, new String[] { "Vehicle ID", "Price/hour",
				"Max # seats", "Available seats", "Model type", "Available for Tours" }) {
			/**
			 * 
			 */
			private static final long serialVersionUID = 1L;
			@SuppressWarnings("rawtypes")
			Class[] columnTypes = new Class[] { String.class, Double.class, Integer.class, Integer.class, String.class,
					Boolean.class };
		...
		gl_panelTours.setHorizontalGroup(gl_panelTours.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelTours.createSequentialGroup()
						.addComponent(panelTopTours, GroupLayout.DEFAULT_SIZE, 1000, Short.MAX_VALUE).addGap(0))
				.addGroup(gl_panelTours.createSequentialGroup().addGap(12)
						...
						.addGroup(gl_panelTours.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panelTours.createSequentialGroup()
										.addComponent(scrollPaneToursArchive, GroupLayout.DEFAULT_SIZE, 481,
												Short.MAX_VALUE)
										.addGap(20))
								.addGroup(gl_panelTours.createSequentialGroup().addComponent(lblDeleteTourBtn)
										.addContainerGap()))));
		gl_panelTours.setVerticalGroup(gl_panelTours.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelTours.createSequentialGroup()
						.addComponent(panelTopTours, GroupLayout.PREFERRED_SIZE, 58, GroupLayout.PREFERRED_SIZE).addGap(
								18)
						.addGroup(gl_panelTours.createParallelGroup(Alignment.LEADING, false)
								...
								.addGroup(gl_panelTours.createSequentialGroup()
										.addComponent(scrollPaneToursArchive, GroupLayout.PREFERRED_SIZE, 351,
												GroupLayout.PREFERRED_SIZE)
										.addGap(18).addComponent(lblDeleteTourBtn)))
						.addContainerGap()));

		JList listToursArchive = new JList();
		listToursArchive.setBackground(new Color(95, 158, 160));
		listToursArchive.setBorder(new CompoundBorder(
		...
		list.setBorder(new CompoundBorder(new TitledBorder(new LineBorder(new Color(255, 255, 255)), "Pick up stops",
				TitledBorder.LEADING, TitledBorder.TOP, null, new Color(255, 255, 255)), new EmptyBorder(3, 3, 3, 3)));
		...
		textField.setBorder(new TitledBorder(new LineBorder(new Color(255, 255, 255)), "DD", TitledBorder.CENTER,
				TitledBorder.TOP, null, new Color(255, 255, 255)));
		textField.setColumns(10);

		textField_1 = new JTextField();
		textField_1.setBorder(new TitledBorder(new LineBorder(new Color(255, 255, 255)), "YYYY", TitledBorder.CENTER,
				TitledBorder.TOP, null, new Color(255, 255, 255)));
		...
		listSelectBus
				.setBorder(
						new CompoundBorder(
								new TitledBorder(new LineBorder(new Color(255, 255, 255)), "Select bus",
										TitledBorder.CENTER, TitledBorder.TOP, null, new Color(255, 255, 255)),
								new EmptyBorder(3, 3, 3, 3)));
		...
		listSelectChauffeur.setBorder(new CompoundBorder(new TitledBorder(new LineBorder(new Color(255, 255, 255)),
				"Select chauffeur", TitledBorder.CENTER, TitledBorder.TOP, null, new Color(255, 255, 255)), null));
		...
		gl_panelAddTour.setHorizontalGroup(gl_panelAddTour.createParallelGroup(Alignment.LEADING).addGroup(
				gl_panelAddTour.createSequentialGroup().addGroup(gl_panelAddTour
						.createParallelGroup(
								Alignment.LEADING)
						.addGroup(gl_panelAddTour.createSequentialGroup()
								.addGroup(gl_panelAddTour.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_panelAddTour.createSequentialGroup().addContainerGap()
												.addGroup(gl_panelAddTour.createParallelGroup(Alignment.LEADING, false)
														...
														.addGroup(gl_panelAddTour.createSequentialGroup()
																...
																.addGroup(gl_panelAddTour
																		.createParallelGroup(Alignment.LEADING, false)
																		.addComponent(textFieldEndMonth, 0, 0,
																				Short.MAX_VALUE)
																		.addComponent(textFieldStartMonth,
																...
																.addGroup(gl_panelAddTour
																		...
																		.addComponent(textFieldStartDay,
																				GroupLayout.DEFAULT_SIZE, 45,
																				Short.MAX_VALUE))
																.addPreferredGap(ComponentPlacement.RELATED)
																.addGroup(gl_panelAddTour
																		.createParallelGroup(Alignment.LEADING, false)
																		.addComponent(textFieldStartYear, 0,
																				0, Short.MAX_VALUE)
																		.addComponent(textField_1,
																				GroupLayout.DEFAULT_SIZE, 96,
																				Short.MAX_VALUE)))))
										.addGroup(gl_panelAddTour.createSequentialGroup().addGap(13).addComponent(
												listSelectBus, GroupLayout.PREFERRED_SIZE, 272,
												GroupLayout.PREFERRED_SIZE)))
								.addGroup(gl_panelAddTour.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_panelAddTour.createSequentialGroup()
												.addPreferredGap(ComponentPlacement.UNRELATED).addGroup(gl_panelAddTour
														.createParallelGroup(Alignment.LEADING, false)
														.addComponent(list, GroupLayout.DEFAULT_SIZE, 148,
																Short.MAX_VALUE)
														.addGroup(gl_panelAddTour.createSequentialGroup()
										...
										.addGroup(gl_panelAddTour.createSequentialGroup().addGap(40)
												.addGroup(gl_panelAddTour.createParallelGroup(Alignment.LEADING)
														.addComponent(chckbxLunch).addComponent(chckbxBreakfast)
														.addComponent(chckbxAllInclusive)
														.addComponent(chckbxEntranceTickets)))))
						.addGroup(gl_panelAddTour.createSequentialGroup().addContainerGap().addComponent(
								listSelectChauffeur, GroupLayout.PREFERRED_SIZE, 271, GroupLayout.PREFERRED_SIZE)))
						.addContainerGap(2, Short.MAX_VALUE))
				.addGroup(Alignment.TRAILING, gl_panelAddTour.createSequentialGroup()
						.addContainerGap(380, Short.MAX_VALUE).addComponent(lblAddTourBtn).addContainerGap()));
		gl_panelAddTour
				.setVerticalGroup(
						gl_panelAddTour.createParallelGroup(Alignment.LEADING).addGroup(gl_panelAddTour
								.createSequentialGroup().addGroup(gl_panelAddTour.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_panelAddTour.createSequentialGroup().addContainerGap()
												...
												.addGroup(gl_panelAddTour.createParallelGroup(Alignment.TRAILING)
														.addComponent(lblEndDate).addGroup(gl_panelAddTour
																.createParallelGroup(Alignment.BASELINE)
																.addComponent(textFieldEndMonth,
																		GroupLayout.PREFERRED_SIZE,
																		GroupLayout.DEFAULT_SIZE,
																		GroupLayout.PREFERRED_SIZE)
																.addComponent(textField, GroupLayout.PREFERRED_SIZE, 39,
																		GroupLayout.PREFERRED_SIZE)
																.addComponent(textField_1, GroupLayout.PREFERRED_SIZE,
																		GroupLayout.DEFAULT_SIZE,
																		GroupLayout.PREFERRED_SIZE)))
												.addGap(22)
												.addComponent(listSelectBus, GroupLayout.PREFERRED_SIZE, 75,
														GroupLayout.PREFERRED_SIZE)
												.addPreferredGap(ComponentPlacement.UNRELATED)
												.addComponent(listSelectChauffeur, GroupLayout.PREFERRED_SIZE, 77,
														GroupLayout.PREFERRED_SIZE))
										.addGroup(gl_panelAddTour.createSequentialGroup()
												.addComponent(list, GroupLayout.PREFERRED_SIZE, 91,
														GroupLayout.PREFERRED_SIZE)
												.addPreferredGap(ComponentPlacement.RELATED)
												...
												.addGap(31).addComponent(chckbxBreakfast)
												.addPreferredGap(ComponentPlacement.UNRELATED).addComponent(chckbxLunch)
												.addPreferredGap(ComponentPlacement.UNRELATED)
												.addComponent(chckbxAllInclusive)
												.addPreferredGap(ComponentPlacement.UNRELATED)
												.addComponent(chckbxEntranceTickets)))
								.addPreferredGap(ComponentPlacement.RELATED, 26, Short.MAX_VALUE)
								.addComponent(lblAddTourBtn).addContainerGap()));
		...
		gl_panelCustomers.setHorizontalGroup(gl_panelCustomers.createParallelGroup(Alignment.LEADING)
				.addGap(0, 1000, Short.MAX_VALUE).addGroup(gl_panelCustomers.createSequentialGroup()
						.addComponent(panelTopCustomers, GroupLayout.DEFAULT_SIZE, 1000, Short.MAX_VALUE).addGap(0)));
		...
		gl_panelPassengers.setHorizontalGroup(gl_panelPassengers.createParallelGroup(Alignment.LEADING)
				.addGap(0, 1000, Short.MAX_VALUE).addGroup(gl_panelPassengers.createSequentialGroup()
						.addComponent(panelTopPassengers, GroupLayout.DEFAULT_SIZE, 1000, Short.MAX_VALUE).addGap(0)));
		...
		gl_panelTopNewTourReservation.setHorizontalGroup(
				gl_panelTopNewTourReservation.createParallelGroup(Alignment.LEADING).addGap(0, 1000, Short.MAX_VALUE)
		...
		gl_panelTopNewTourReservation.setVerticalGroup(
				gl_panelTopNewTourReservation.createParallelGroup(Alignment.LEADING).addGap(0, 58, Short.MAX_VALUE)
		...
		gl_panelNewTourReservation
				.setHorizontalGroup(gl_panelNewTourReservation.createParallelGroup(Alignment.TRAILING)
						.addGroup(gl_panelNewTourReservation.createSequentialGroup()
								.addComponent(panelTopNewTourReservation, GroupLayout.DEFAULT_SIZE, 1000,
										Short.MAX_VALUE)
								.addGap(0))
						.addGroup(Alignment.LEADING, gl_panelNewTourReservation.createSequentialGroup().addGap(12)
								.addComponent(newTourReservationTabbedPanel, GroupLayout.PREFERRED_SIZE, 654,
										GroupLayout.PREFERRED_SIZE)
								.addGroup(gl_panelNewTourReservation.createParallelGroup(Alignment.LEADING)
										.addGroup(gl_panelNewTourReservation.createSequentialGroup().addGap(18)
												.addGroup(gl_panelNewTourReservation
														.createParallelGroup(Alignment.LEADING)
														.addComponent(lblSelectedTour, GroupLayout.PREFERRED_SIZE, 279,
																GroupLayout.PREFERRED_SIZE)
														.addComponent(lblSelectedCustomer, GroupLayout.PREFERRED_SIZE,
																279, GroupLayout.PREFERRED_SIZE)
														.addComponent(lblSelectedPassengers, GroupLayout.PREFERRED_SIZE,
																279, GroupLayout.PREFERRED_SIZE)))
										.addGroup(gl_panelNewTourReservation.createSequentialGroup().addGap(73)
		...
		gl_panelNewTourReservation.setVerticalGroup(gl_panelNewTourReservation.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_panelNewTourReservation.createSequentialGroup()
						...
						.addGroup(gl_panelNewTourReservation.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_panelNewTourReservation.createSequentialGroup()
										.addPreferredGap(ComponentPlacement.RELATED)
										.addComponent(newTourReservationTabbedPanel, GroupLayout.PREFERRED_SIZE, 366,
												GroupLayout.PREFERRED_SIZE)
										.addContainerGap(51, Short.MAX_VALUE))
								.addGroup(gl_panelNewTourReservation.createSequentialGroup().addGap(32)
										.addComponent(lblSelectedTour, GroupLayout.PREFERRED_SIZE, 46,
												GroupLayout.PREFERRED_SIZE)
										.addGap(18)
										.addComponent(lblSelectedCustomer, GroupLayout.PREFERRED_SIZE, 46,
												GroupLayout.PREFERRED_SIZE)
										.addGap(18)
										.addComponent(lblSelectedPassengers, GroupLayout.PREFERRED_SIZE, 46,
												GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(ComponentPlacement.RELATED, 113, Short.MAX_VALUE)
										.addComponent(lblCreateReservationButton, GroupLayout.PREFERRED_SIZE, 46,
												GroupLayout.PREFERRED_SIZE)
										.addGap(59)))));
		...
		gl_selectTourPanel.setHorizontalGroup(gl_selectTourPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_selectTourPanel.createSequentialGroup().addContainerGap().addGroup(gl_selectTourPanel
						.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_selectTourPanel.createSequentialGroup().addComponent(lblSearchByDestination)
								.addGap(18).addComponent(searchTourTextField, GroupLayout.PREFERRED_SIZE,
										GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE))
						.addComponent(selectTourScrollPanel, GroupLayout.PREFERRED_SIZE, 630,
								GroupLayout.PREFERRED_SIZE)
		...
		gl_selectTourPanel.setVerticalGroup(gl_selectTourPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_selectTourPanel.createSequentialGroup().addGap(37)
						.addGroup(gl_selectTourPanel.createParallelGroup(Alignment.BASELINE)
								.addComponent(lblSearchByDestination).addComponent(searchTourTextField,
										GroupLayout.PREFERRED_SIZE, 26, GroupLayout.PREFERRED_SIZE))
						.addGap(18)
						.addComponent(selectTourScrollPanel, GroupLayout.PREFERRED_SIZE, 190,
								GroupLayout.PREFERRED_SIZE)
						.addGap(18)
		...
		tableToursForNewReservation.setModel(new DefaultTableModel(new Object[][] {},
				new String[] { "Destination", "Departure date", "Number of available seats", "Bus", "Chauffeur" }));
		...
		gl_selectCustomerPanel.setHorizontalGroup(
				gl_selectCustomerPanel.createParallelGroup(Alignment.LEADING).addGroup(gl_selectCustomerPanel
						.createSequentialGroup().addContainerGap().addGroup(gl_selectCustomerPanel
								.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_selectCustomerPanel.createParallelGroup(Alignment.LEADING, false)
										.addComponent(selectCustomerScrollPanel, GroupLayout.DEFAULT_SIZE, 581,
												Short.MAX_VALUE)
										.addGroup(gl_selectCustomerPanel.createSequentialGroup()
												.addComponent(lblSearchCustomerByName, GroupLayout.PREFERRED_SIZE, 143,
														GroupLayout.PREFERRED_SIZE)
												.addPreferredGap(ComponentPlacement.RELATED)
												.addComponent(searchCustomerTextField, GroupLayout.PREFERRED_SIZE,
														GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)))
								.addComponent(lblSelectCustomerButton, GroupLayout.PREFERRED_SIZE, 73,
										GroupLayout.PREFERRED_SIZE))
						.addContainerGap(56, Short.MAX_VALUE)));
		gl_selectCustomerPanel.setVerticalGroup(gl_selectCustomerPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_selectCustomerPanel.createSequentialGroup().addGap(28)
						.addGroup(gl_selectCustomerPanel
								.createParallelGroup(Alignment.TRAILING, false).addComponent(searchCustomerTextField)
								.addComponent(lblSearchCustomerByName, GroupLayout.DEFAULT_SIZE, 23, Short.MAX_VALUE))
						.addGap(18)
						.addComponent(selectCustomerScrollPanel, GroupLayout.PREFERRED_SIZE, 191,
								GroupLayout.PREFERRED_SIZE)
						.addGap(26).addComponent(lblSelectCustomerButton, GroupLayout.PREFERRED_SIZE, 25,
								GroupLayout.PREFERRED_SIZE)
		...
		tableCustomersForNewReservation.setModel(new DefaultTableModel(new Object[][] {},
				new String[] { "Full name", "Phone number", "Address", "Date of birth", "Email" }));
				...
				.addGroup(gl_selectPassengersPanel.createSequentialGroup().addContainerGap()
						.addGroup(gl_selectPassengersPanel.createParallelGroup(Alignment.LEADING)
								.addGroup(gl_selectPassengersPanel.createParallelGroup(Alignment.LEADING, false)
										.addComponent(selectPassengersScrollPanel, GroupLayout.DEFAULT_SIZE, 581,
												Short.MAX_VALUE)
										.addGroup(gl_selectPassengersPanel.createSequentialGroup()
												.addComponent(lblSearchPassengersByName, GroupLayout.PREFERRED_SIZE,
														143, GroupLayout.PREFERRED_SIZE)
												.addPreferredGap(ComponentPlacement.RELATED)
												.addComponent(searchPassengersTextField, GroupLayout.PREFERRED_SIZE,
														GroupLayout.DEFAULT_SIZE, GroupLayout.PREFERRED_SIZE)))
								.addComponent(lblSelectPassengersButton, GroupLayout.PREFERRED_SIZE, 73,
										GroupLayout.PREFERRED_SIZE))
						.addContainerGap(56, Short.MAX_VALUE)));
		gl_selectPassengersPanel.setVerticalGroup(gl_selectPassengersPanel.createParallelGroup(Alignment.LEADING)
				.addGroup(gl_selectPassengersPanel.createSequentialGroup().addGap(19)
						.addGroup(gl_selectPassengersPanel
								.createParallelGroup(Alignment.TRAILING, false).addComponent(searchPassengersTextField)
								.addComponent(lblSearchPassengersByName, GroupLayout.DEFAULT_SIZE, 23, Short.MAX_VALUE))
						.addGap(18)
						.addComponent(selectPassengersScrollPanel, GroupLayout.PREFERRED_SIZE, 191,
								GroupLayout.PREFERRED_SIZE)
						.addPreferredGap(ComponentPlacement.RELATED, 31, Short.MAX_VALUE)
						.addComponent(lblSelectPassengersButton, GroupLayout.PREFERRED_SIZE, 25,
								GroupLayout.PREFERRED_SIZE)
						.addGap(29)));
		...
		tablePassengersForNewReservation.setModel(new DefaultTableModel(new Object[][] {},
				new String[] { "Full name", "Address", "Date of birth", "Email" }));
		...
		gl_panelNewBusReservation.setHorizontalGroup(gl_panelNewBusReservation.createParallelGroup(Alignment.LEADING)
				.addGap(0, 1000, Short.MAX_VALUE)
		...
		gl_panelNewBusReservation.setVerticalGroup(
				gl_panelNewBusReservation.createParallelGroup(Alignment.LEADING).addGap(0, 494, Short.MAX_VALUE)
